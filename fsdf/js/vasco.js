async function fetchProbabilities() {
    const data = [
        { match: 'Vasco da Gama vs Internacional', teamA: 70, teamB: 30, date: '21/11/2024' },
        { match: 'Vasco da Gama vs Corinthians', teamA: 65, teamB: 35, date: '24/11/2024' },
        { match: 'Vasco da Gama vs Atlético Goiano', teamA: 60, teamB: 40, date: '30/11/2024' },
        { match: 'Vasco da Gama vs Atlético Mineiro', teamA: 75, teamB: 25, date: '04/12/2024' },
        { match: 'Vasco da Gama vs Cuiabá', teamA: 55, teamB: 45, date: '08/12/2024' },
    ];
