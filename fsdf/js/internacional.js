async function fetchProbabilities() {
    const data = [
        { match: 'Internacional vs Vasco da Gama', teamA: 60, teamB: 40, date: '21/11/2024' },
        { match: 'Internacional vs Bragantino', teamA: 70, teamB: 30, date: '24/11/2024' },
        { match: 'Internacional vs Flamengo', teamA: 60, teamB: 40, date: '01/12/2024' },
        { match: 'Internacional vs Botafogo', teamA: 80, teamB: 20, date: '04/12/2024' },
        { match: 'Internacional vs Fortaleza', teamA: 55, teamB: 45, date: '08/12/2024' },
    ];
